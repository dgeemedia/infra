...
var RegisterWebhookDto = function () {
    var _a;
    var _url_decorators;
    ...
    return _a = /** @class */ (function () {
        ...
        (function () {
            ...
            _url_decorators = [(0, class_validator_1.IsUrl)({}, { message: 'url must be a valid HTTPS URL' })];
            _events_decorators = [(0, class_validator_1.IsArray)(), (0, class_validator_1.IsEnum)(['payout.delivered', 'payout.failed', 'payout.processing', 'payout.flagged'], { each: true })];
...
var WebhooksController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('Webhooks'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.Controller)('v1/webhooks')];
    ...
    var WebhooksController = _classThis = /** @class */ (function () {
        function WebhooksController_1(webhooksService) {
            this.webhooksService = (__runInitializers(this, _instanceExtraInitializers), webhooksService);
        }
        WebhooksController_1.prototype.register = function (partner, dto) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.webhooksService.register(partner.id, dto.url, dto.events)];
                });
            });
        };
        WebhooksController_1.prototype.list = function (partner) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.webhooksService.list(partner.id)];
                });
            });
        };
    ...
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _register_decorators = [(0, common_1.Post)(), (0, common_1.HttpCode)(common_1.HttpStatus.CREATED), (0, swagger_1.ApiOperation)({ summary: 'Register a webhook URL' }), openapi.ApiResponse({ status: common_1.HttpStatus.CREATED })];
        _list_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'List all registered webhooks' }), openapi.ApiResponse({ status: 200 })];
