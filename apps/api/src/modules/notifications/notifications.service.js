...
var NotificationsService = function () {
    ...
    var NotificationsService = _classThis = /** @class */ (function () {
        ...
        NotificationsService_1.prototype.create = function (partnerId, type, title, body, metadata) {
        ...
        NotificationsService_1.prototype.list = function (partnerId) {
            return __awaiter(this, void 0, void 0, function () {
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, this.prisma.notification.count({
                                    where: { partnerId: partnerId, read: false },
                                })];
                        case 2:
                            unreadCount = _a.sent();
                            return [2 /*return*/, { notifications: notifications, unreadCount: unreadCount }];
                    }
                });
            });
        };
        // ── Mark a single notification as read ────────────────────────────
        NotificationsService_1.prototype.markRead = function (partnerId, notificationId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.notification.updateMany({
                            where: { id: notificationId, partnerId: partnerId },
                            data: { read: true },
                        })];
                });
            });
        ...
        NotificationsService_1.prototype.markAllRead = function (partnerId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.notification.updateMany({
                            where: { partnerId: partnerId, read: false },
