...
var AuthController = function () {
        ...
        AuthController_1.prototype.login = function (dto) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.authService.loginDashboard(dto.email, dto.password)];
                        case 1:
                            result = _a.sent();
    ...
    (function () {
        var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
        _login_decorators = [(0, common_1.Post)('login'), (0, public_decorator_1.Public)(), (0, common_1.HttpCode)(common_1.HttpStatus.OK), (0, swagger_1.ApiOperation)({ summary: 'Dashboard login — returns JWT access token' }), openapi.ApiResponse({ status: common_1.HttpStatus.OK })];
