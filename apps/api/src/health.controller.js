...
var HealthController = function () {
    ...
    var HealthController = _classThis = /** @class */ (function () {
        function HealthController_1(health, memory, prisma) {
        ...
        HealthController_1.prototype.check = function () {
            ...
            return this.health.check([
                ...
                function () { return _this.memory.checkHeap('memory_heap', 512 * 1024 * 1024); },
            ]);
        };
    ...
    (function () {
        ...
        _check_decorators = [(0, common_1.Get)(), (0, public_decorator_1.Public)(), (0, terminus_1.HealthCheck)(), (0, swagger_1.ApiOperation)({ summary: 'Health check — used by AWS ALB and monitoring' }), openapi.ApiResponse({ status: 200, type: Object })];
