...
var ApiKeyGuard = function () {
    ...
    var ApiKeyGuard = _classThis = /** @class */ (function () {
        function ApiKeyGuard_1(authService, reflector) {
            this.authService = authService;
            this.reflector = reflector;
        }
        ApiKeyGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var isPublic, request, authHeader, _a, scheme, token, partner_1, partner;
                        ...
                        case 0:
                            ...
                            if (!authHeader) {
                                throw new common_1.UnauthorizedException({
                                    code: constants_1.ERROR_CODES.MISSING_API_KEY,
                            ...
                            if (!this.isJwt(token)) return [3 /*break*/, 2];
                            return [4 /*yield*/, this.authService.validateJwtToken(token)];
                        case 1:
                            partner_1 = _b.sent();
                            if (!partner_1) {
                                throw new common_1.UnauthorizedException({
                                    code: constants_1.ERROR_CODES.INVALID_API_KEY,
                                    message: 'Session expired or invalid. Please sign in again.',
                                });
                            }
                            request.partner = partner_1;
                            return [2 /*return*/, true];
                        case 2: return [4 /*yield*/, this.authService.validateApiKey(token)];
                        case 3:
                            partner = _b.sent();
                            if (!partner) {
                                throw new common_1.UnauthorizedException({
        ...
        ApiKeyGuard_1.prototype.isJwt = function (token) {
